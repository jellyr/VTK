...
//----------------------------------------------------------------------------
inline void vtkBlueObeliskDataParser::parseFloat3(const char *d, float arr[3])
{
  unsigned short ind = 0;
  // Make copy of d for strtok.:
  unsigned int dlength = 0;
  // Using postfix++ will include terminating NULL
  while (d[dlength++]) {};
  char dcopy[dlength];
...
{
  return static_cast<unsigned int>(atoi(d));
}
