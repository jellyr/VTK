  ...
  vtkInformationVector* outputVector)
{
  ...
  radii.reserve(numArr->GetNumberOfTuples());
  for (unsigned short *it = numArr->GetPointer(0),
       *it_end = it + numArr->GetNumberOfTuples();
       it != it_end; ++it)
    {
    radii.push_back(pTab->GetCovalentRadius(*it));
    }
