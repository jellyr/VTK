...
class VTK_CHEMISTRY_EXPORT vtkBlueObeliskData : public vtkObject
{
 public:
  ...
  vtkGetVtkNewMacro(Symbols, vtkStringArray);
  vtkGetVtkNewMacro(LowerSymbols, vtkStringArray);
  vtkGetVtkNewMacro(Names, vtkStringArray);
  vtkGetVtkNewMacro(LowerNames, vtkStringArray);
  vtkGetVtkNewMacro(PeriodicTableBlocks, vtkStringArray);
  vtkGetVtkNewMacro(ElectronicConfigurations, vtkStringArray);
  vtkGetVtkNewMacro(Families, vtkStringArray);

  vtkGetVtkNewMacro(Masses, vtkFloatArray);
  vtkGetVtkNewMacro(ExactMasses, vtkFloatArray);
  vtkGetVtkNewMacro(IonizationEnergies, vtkFloatArray);
  vtkGetVtkNewMacro(ElectronAffinities, vtkFloatArray);
  vtkGetVtkNewMacro(PaulingElectronegativities, vtkFloatArray);
  vtkGetVtkNewMacro(CovalentRadii, vtkFloatArray);
  vtkGetVtkNewMacro(VDWRadii, vtkFloatArray);
  vtkGetVtkNewMacro(DefaultColors, vtkFloatArray);
  vtkGetVtkNewMacro(BoilingPoints, vtkFloatArray);
  vtkGetVtkNewMacro(MeltingPoints, vtkFloatArray);

  vtkGetVtkNewMacro(Periods, vtkUnsignedShortArray);
  vtkGetVtkNewMacro(Groups, vtkUnsignedShortArray);
