...
public:
  ...
  // VDWRadius.
  vtkGetMacro(AtomicRadiusType, RadiusType);
  vtkSetMacro(AtomicRadiusType, RadiusType);
  ...
  vtkGetMacro(BondColorMode, BondColorModeType);
  vtkSetMacro(BondColorMode, BondColorModeType);
...
protected:
  ...
  bool RenderAtoms;
  RadiusType AtomicRadiusType;
  float AtomicRadiusScaleFactor;

  // Description:
  // Customize bond rendering
  bool RenderBonds;
  BondColorModeType BondColorMode;
