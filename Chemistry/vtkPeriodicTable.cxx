...
unsigned short vtkPeriodicTable::GetAtomicNumber(const char *str)
{
  ...
  // return 0.
  if (!str || !this->BlueObeliskData->IsInitialized())
    {
    return 0;
    }
  ...
  // Cache pointers:
  register vtkStringArray *lnames = this->BlueObeliskData->GetLowerNames();
  register vtkStringArray *lsymbols =
    this->BlueObeliskData->GetLowerSymbols();
  register const unsigned short numElements =
